...
rm -rf tools/ballerinaByExample/tools/all-bbes.json
cp ballerina-lang/examples/index.json tools/ballerinaByExample/tools/all-bbes.json
...
go run tools/ballerinaByExample/tools/generate.go "target/dependencies/ballerina-examples" $SITE_VERSION $BBE_GEN_DIR $GEN_FOR_JEKYLL
